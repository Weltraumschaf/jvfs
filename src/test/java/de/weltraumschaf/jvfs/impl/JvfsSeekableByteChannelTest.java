...
/**
 * Tests to assert that the {@link JvfsSeekableByteChannel} is working as contracted.
 *
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
public class JvfsSeekableByteChannelTest {
     ...
     * Instance under test.
     */
    private JvfsSeekableByteChannel channel;
